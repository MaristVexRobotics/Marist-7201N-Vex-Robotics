...
void drive(){
	LEFT_BACK = (leftYStick) + (leftUpBumper*127) - (rightUpBumper*127) + leftUBtn*40 - leftDBtn*40;
	LEFT_FRONT = (leftYStick) - (leftUpBumper*127) + (rightUpBumper*127) + leftUBtn*40 - leftDBtn*40;
	RIGHT_BACK = (rightYStick) + (rightUpBumper*127) - (leftUpBumper*127) + leftUBtn*40 - leftDBtn*40;
	RIGHT_FRONT = (rightYStick) - (rightUpBumper*127) + (leftUpBumper*127) + leftUBtn*40 - leftDBtn*40;
